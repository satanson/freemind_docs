...
<node CREATED="1355458302900" FOLDED="true" ID="ID_1687987652" MODIFIED="1397636600589" POSITION="right" TEXT="$@%&amp;*\">
...
<node CREATED="1355456638566" FOLDED="true" ID="ID_303866383" MODIFIED="1397273923741" TEXT="create">
...
<node CREATED="1355459069971" FOLDED="true" ID="ID_380599138" MODIFIED="1397721914035" POSITION="right" TEXT="program organization">
...
<node CREATED="1358929184506" FOLDED="true" ID="ID_15855385" MODIFIED="1366128361317" TEXT="subprocess">
...
<node CREATED="1359699686225" FOLDED="true" ID="ID_1330420173" MODIFIED="1397233632377" POSITION="right" TEXT="perlmod">
...
<node CREATED="1397721976676" ID="ID_1578668090" MODIFIED="1397721979416" POSITION="right" TEXT="Getopt">
<node CREATED="1397721966050" FOLDED="true" ID="ID_1802196089" MODIFIED="1397725796037" TEXT="Getopt::Long ">
...
<node CREATED="1397213951119" FOLDED="true" ID="ID_283932399" MODIFIED="1397236562541" POSITION="right" TEXT="core modules">
...
<node CREATED="1397234621765" FOLDED="true" ID="ID_1680827926" MODIFIED="1397234883436" TEXT="IPC::Cmd">
<node CREATED="1397234634694" ID="ID_136745109" MODIFIED="1397234636054" TEXT="- finding and running system commands made easy"/>
<node CREATED="1397234650021" ID="ID_883030995" MODIFIED="1397234651071" TEXT="$path = can_run( PROGRAM );"/>
<node CREATED="1397234664182" ID="ID_1843749039" MODIFIED="1397234664925" TEXT="$ok | ($ok, $err, $full_buf, $stdout_buff, $stderr_buff) = run( command =&gt; COMMAND, [verbose =&gt; BOOL, buffer =&gt; \$SCALAR, timeout =&gt; DIGIT] );"/>
<node CREATED="1397234721825" ID="ID_1869957347" MODIFIED="1397234722951" TEXT="$hashref = run_forked( COMMAND, { child_stdin =&gt; SCALAR, timeout =&gt; DIGIT, stdout_handler =&gt; CODEREF, stderr_handler =&gt; CODEREF} );"/>
<node CREATED="1397234817501" ID="ID_1492052273" MODIFIED="1397234822837" TEXT="$q = QUOTE"/>
</node>
<node CREATED="1397234884324" FOLDED="true" ID="ID_1570846888" MODIFIED="1397235018614" TEXT="IPC::Open2">
<node CREATED="1397234897544" ID="ID_760522762" MODIFIED="1397234898592" TEXT=" - open a process for both reading and writing using open2()"/>
<node CREATED="1397234986976" ID="ID_744522580" MODIFIED="1397234989284" TEXT="$pid = open2(\*CHLD_OUT, \*CHLD_IN, &apos;some cmd and args&apos;);"/>
<node CREATED="1397234995653" ID="ID_1669034334" MODIFIED="1397234996481" TEXT=" $pid = open2(\*CHLD_OUT, \*CHLD_IN, &apos;some&apos;, &apos;cmd&apos;, &apos;and&apos;, &apos;args&apos;);"/>
</node>
<node CREATED="1397235019533" FOLDED="true" ID="ID_1690469547" MODIFIED="1397235187961" TEXT="IPC::Open3">
<node CREATED="1397235029453" ID="ID_1526484473" MODIFIED="1397235030332" TEXT="IPC::Open3 - open a process for reading, writing, and error handling using open3()"/>
<node CREATED="1397235056703" ID="ID_694044297" MODIFIED="1397235057673" TEXT="$pid = open3(\*CHLD_IN, \*CHLD_OUT, \*CHLD_ERR, &#x9;&#x9;    &apos;some cmd and args&apos;, &apos;optarg&apos;, ...);"/>
</node>
<node CREATED="1397235188717" FOLDED="true" ID="ID_188097099" MODIFIED="1397235260045" TEXT="IPC::Run">
<node CREATED="1397235198930" ID="ID_584644376" MODIFIED="1397235199914" TEXT="- system() and background procs w/ piping, redirs, ptys (Unix, Win32)"/>
</node>
...
<node CREATED="1397236358333" FOLDED="true" ID="ID_1887728701" MODIFIED="1397236560472" TEXT="Carp">
<node CREATED="1397236417316" ID="ID_656520845" MODIFIED="1397236419103" TEXT="- alternative warn and die for modules"/>
<node CREATED="1397236407410" ID="ID_208628407" MODIFIED="1397236408510" TEXT="carp "/>
<node CREATED="1397236431638" ID="ID_1273090459" MODIFIED="1397236433544" TEXT="croak"/>
<node CREATED="1397236442813" ID="ID_812624420" MODIFIED="1397236443750" TEXT="confess"/>
<node CREATED="1397236451491" ID="ID_1988425250" MODIFIED="1397236452183" TEXT="cluck"/>
</node>
</node>
...
<node CREATED="1359350429798" FOLDED="true" ID="ID_888504788" MODIFIED="1397373289497" POSITION="right" TEXT="file IO">
...
<node CREATED="1358918915099" FOLDED="true" ID="ID_1002703275" MODIFIED="1397273243214" TEXT="open FILEHANDLE">
...
<node CREATED="1359643310097" FOLDED="true" ID="ID_871520906" MODIFIED="1397136866327" POSITION="right" TEXT="thingy (ref EXPR)">
