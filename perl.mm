...
<node CREATED="1355458302900" FOLDED="true" ID="ID_1687987652" MODIFIED="1400229515730" POSITION="right" TEXT="$@%&amp;*\">
...
<node CREATED="1355456156918" FOLDED="true" ID="ID_1667849684" MODIFIED="1398063525181" STYLE="fork" TEXT="\ hard reference">
...
<node CREATED="1355459629280" ID="ID_1638982163" MODIFIED="1400722448446" POSITION="right" TEXT="regexp">
...
<node CREATED="1357892041587" FOLDED="true" ID="ID_1896153208" MODIFIED="1397007779114" TEXT="anchor(boundary)">
...
<node CREATED="1357866758865" FOLDED="true" ID="ID_1956782628" MODIFIED="1378832427858" TEXT="[m]//g global match">
<icon BUILTIN="full-2"/>
...
<node CREATED="1366779986470" ID="ID_331947889" MODIFIED="1400722448462" TEXT="tr///cds or y///cds">
<icon BUILTIN="full-6"/>
...
<node CREATED="1355459069971" FOLDED="true" ID="ID_380599138" MODIFIED="1398069544695" POSITION="right" TEXT="program organization">
...
<node CREATED="1355459660214" ID="ID_275176102" MODIFIED="1398065296332" TEXT="stmt">
...
<node CREATED="1355459560152" ID="ID_1757534519" MODIFIED="1398065299567" TEXT="control flow">
...
<node CREATED="1355488712376" FOLDED="true" ID="ID_1505335518" MODIFIED="1398065385241" TEXT="redo [LABEL];">
...
<node CREATED="1359699686225" FOLDED="true" ID="ID_1330420173" MODIFIED="1400229510883" POSITION="right" TEXT="perlmod">
<node CREATED="1359374100309" FOLDED="true" ID="ID_1513732848" MODIFIED="1397136755814" TEXT="package(namespace)">
<node CREATED="1366297872564" ID="ID_1444632013" MODIFIED="1397136656912" TEXT="package declaration">
...
<node CREATED="1366295044007" FOLDED="true" ID="ID_1576547386" MODIFIED="1397136687531" TEXT="refer package/dynamic/global identifier">
...
<node CREATED="1358694919256" ID="ID_754397662" MODIFIED="1397136673967" TEXT="separator">
...
<node CREATED="1359378235208" ID="ID_1146278733" MODIFIED="1397136682710" TEXT="not support partial qualified identifiers(relative path)">
...
<node CREATED="1359378201767" FOLDED="true" ID="ID_1188839208" MODIFIED="1397136655029" TEXT="nested packages">
<node CREATED="1359377737576" ID="ID_1043958384" MODIFIED="1397136644846" TEXT="$OUTER::INNER::Variable">
...
<node CREATED="1359374108067" FOLDED="true" ID="ID_1263092462" MODIFIED="1397136701909" TEXT="main package (%main:: or %::)">
...
<node CREATED="1359379034464" ID="ID_51019265" MODIFIED="1397136695437" TEXT="symbol table">
...
<node CREATED="1359374561403" FOLDED="true" ID="ID_539695056" MODIFIED="1397136749527" TEXT="symbol table (%Package::)">
...
<node CREATED="1366299452871" FOLDED="true" ID="ID_1507997446" MODIFIED="1397136751544" TEXT="__PACKAGE__">
...
<node CREATED="1355460047555" FOLDED="true" ID="ID_1021967777" MODIFIED="1400229510105" TEXT="module">
...
<node CREATED="1359473114753" FOLDED="true" ID="ID_1606765100" MODIFIED="1397213932728" TEXT="export/import symbols">
<node CREATED="1359556950347" ID="ID_1405404207" MODIFIED="1397212064125" TEXT="use Module;">
<node CREATED="1359556971512" ID="ID_1117478363" MODIFIED="1359557078776" TEXT="@EXPORT (default)"/>
<node CREATED="1366300619143" ID="ID_1704112987" MODIFIED="1397212066777" TEXT="eq">
<node CREATED="1366300573279" ID="ID_675003047" MODIFIED="1366300622667" TEXT="BEGIN { require &apos;Module.pm&apos;; &apos;Module&apos;-&gt;import; }"/>
</node>
</node>
<node CREATED="1359556951150" ID="ID_1594222725" MODIFIED="1397212070159" TEXT="use Module qw(...);">
...
<node CREATED="1366300626823" ID="ID_1536534160" MODIFIED="1397212081536" TEXT="eq">
<node CREATED="1366300613944" ID="ID_1195137442" MODIFIED="1366300628956" TEXT="BEGIN { require &apos;Module.pm&apos;; &apos;Module&apos;-&gt;import( LIST ); }"/>
</node>
</node>
<node CREATED="1359557144256" ID="ID_1484650484" MODIFIED="1397212074212" TEXT="use Module();">
...
<node CREATED="1366300797607" FOLDED="true" ID="ID_692853297" MODIFIED="1397213928098" TEXT="">
...
<node CREATED="1355460052140" ID="ID_1071890157" MODIFIED="1366766581199" TEXT="export/import symbol">
...
<node CREATED="1355446920750" ID="ID_1465118100" MODIFIED="1366766583975" TEXT="require (run-time)">
<node CREATED="1358702261388" ID="ID_671014254" MODIFIED="1358702263708" TEXT="require Foo::Bar;"/>
<node CREATED="1366766593997" ID="ID_103788007" MODIFIED="1366766608553" TEXT="require &quot;Foo/Bar.pm&quot;"/>
...
<node CREATED="1357958859087" ID="ID_1070048068" MODIFIED="1397136762705" TEXT="@INC">
<node CREATED="1358701029157" ID="ID_705315535" MODIFIED="1358702380337" TEXT="use lib &apos;/mypath/libdir/&apos;;"/>
</node>
<node CREATED="1366301055343" ID="ID_1281559828" MODIFIED="1397136764559" TEXT="%INC">
...
<node CREATED="1397721976676" FOLDED="true" ID="ID_1578668090" MODIFIED="1400229506914" POSITION="right" TEXT="Getopt">
<node CREATED="1397721966050" ID="ID_1802196089" MODIFIED="1397807678149" TEXT="Getopt::Long ">
<node CREATED="1397722066714" ID="ID_1159417182" MODIFIED="1397724856955" TEXT="GetOptions(&quot;option{!|+|{=|:}{i|f|s}{|@|%|\{a,b\}}}&quot;)">
<node CREATED="1397722898684" ID="ID_1871693021" MODIFIED="1397722943859" TEXT="=(required) :(optional)"/>
<node CREATED="1397722946095" ID="ID_561915085" MODIFIED="1397722975623" TEXT="i (integer default) f(float) s(string)"/>
<node CREATED="1397722978295" ID="ID_660673919" MODIFIED="1397723121993" TEXT="&quot;verbose!&quot;=&gt;\$verbose #negatable">
<node CREATED="1397723092908" ID="ID_680565511" MODIFIED="1397723227217" TEXT="--verbose #verbose=1"/>
<node CREATED="1397723097023" ID="ID_1198443067" MODIFIED="1397723233706" TEXT="--noverbose #verbose=0"/>
</node>
<node CREATED="1397723361741" ID="ID_624716516" MODIFIED="1397723387128" TEXT="&quot;count+&quot;=&gt;\$count # increment option"/>
<node CREATED="1397723391446" ID="ID_44863646" MODIFIED="1397723454202" TEXT="-- #stop Getopt::Long from processing further arguments"/>
<node CREATED="1397723456041" ID="ID_398585200" MODIFIED="1397724774555" TEXT="&quot;inc=s&quot;=&gt;\@inc # --inc /usr/include --inc /usr/local/include"/>
<node CREATED="1397724757839" ID="ID_1553574777" MODIFIED="1397724788128" TEXT="&quot;inc=$@&quot;=&gt;\inc # --inc /usr/include --inc /usr/local/include"/>
<node CREATED="1397724789554" ID="ID_1353831507" MODIFIED="1397725250107" TEXT="&quot;classpath=s{1,}&quot; # --classpath foobar1.jar foobar2.jar ">
<node CREATED="1397725251140" ID="ID_1047139700" MODIFIED="1397725266956" TEXT="javac --classpath foobar1.jar:foobar2.jar"/>
</node>
<node CREATED="1397724951366" ID="ID_503322701" MODIFIED="1397725389072" TEXT="&quot;D=i&quot;=&gt;\%define # --DDEBUG=1 --D__x86_64__=1">
<node CREATED="1397725394237" ID="ID_505863564" MODIFIED="1397725417691" TEXT="g++ -DDEBUG=1 -D__x86_64__=1"/>
</node>
<node CREATED="1397725422175" ID="ID_1109704196" MODIFIED="1397725709868" TEXT="&quot;e=i%&quot;=&gt;\$environment_override # --e dbg=1 --e CXXFLAGS=&quot;-lpthread -lrt&quot;">
<node CREATED="1397725711649" ID="ID_1170798284" MODIFIED="1397725787701" TEXT="make -e dbg=1 -e CXXFLAGS=&quot;-lphread -lrt&quot;"/>
</node>
</node>
</node>
<node CREATED="1397721916796" ID="ID_1468045151" MODIFIED="1397721981995" TEXT="Getopt::Std ">
<node CREATED="1397722591268" ID="ID_1596689670" MODIFIED="1397722593649" TEXT="getopts">
<node CREATED="1397722073449" ID="ID_468874854" MODIFIED="1397722595412" TEXT="getopts(&quot;bde:f:ghlLnNpstT:wW:y&quot;, \%opts);"/>
<node CREATED="1397722122190" ID="ID_1258439942" MODIFIED="1397722595412" TEXT="%opts=(&apos;e&apos;=&gt;&apos;oo&apos;, &apos;f&apos;=&gt;&apos;default.cow&apos;,&apos;n&apos;=&gt;0,&apos;T&apos;=&gt;&apos;&apos; ,&apos;w&apos;=40); #default options;"/>
<node CREATED="1397722533436" ID="ID_1354301225" MODIFIED="1397722595411" TEXT="display_help if $opts{&apos;h&apos;};"/>
</node>
</node>
</node>
<node CREATED="1358929184506" FOLDED="true" ID="ID_15855385" MODIFIED="1400229519411" POSITION="right" TEXT="multiprocess">
...
<node CREATED="1358658946845" FOLDED="true" ID="ID_1796981812" MODIFIED="1397806001052" TEXT="$CHILD_ERROR($?)">
...
<node CREATED="1397213951119" FOLDED="true" ID="ID_283932399" MODIFIED="1400258576763" POSITION="right" TEXT="core modules">
...
<node CREATED="1359469587102" FOLDED="true" ID="ID_1231265054" MODIFIED="1397272257572" POSITION="right" TEXT="phase (BEGIN...END)">
...
<node CREATED="1358080645743" ID="ID_1176601912" MODIFIED="1400258579454" POSITION="right" TEXT="perlfunc">
...
<node CREATED="1359350429798" FOLDED="true" ID="ID_888504788" MODIFIED="1398061660989" POSITION="right" TEXT="file IO">
...
<node CREATED="1365607710540" FOLDED="true" ID="ID_518375852" MODIFIED="1397630194626" POSITION="right" TEXT="range operator (.. or ...)">
...
<node CREATED="1355397579000" FOLDED="true" ID="ID_1469854044" MODIFIED="1397136813766" POSITION="right" TEXT="help">
...
<node CREATED="1357913837719" FOLDED="true" ID="ID_955721472" MODIFIED="1397230013230" POSITION="right" TEXT="charset(utf8)">
...
<node CREATED="1364052656461" FOLDED="true" ID="ID_831235029" MODIFIED="1397136840579" POSITION="right" TEXT="mess">
<node CREATED="1359712803681" FOLDED="true" ID="ID_650895025" MODIFIED="1397135952848" TEXT="Perl Culture">
...
<node CREATED="1359695159091" FOLDED="true" ID="ID_215538007" MODIFIED="1397135935931" TEXT="current">
...
<node CREATED="1359699557928" FOLDED="true" ID="ID_842313486" MODIFIED="1397136837261" TEXT="Perl lib">
...
<node CREATED="1358936189823" FOLDED="true" ID="ID_1303380453" MODIFIED="1397136828608" TEXT="perl -i.orig -pe &apos;s/\bfoo\b/bar/g&apos; *.[Cchy]">
...
<node CREATED="1355462338875" FOLDED="true" ID="ID_1099640109" MODIFIED="1397136868306" POSITION="right" TEXT="OOP">
...
<node CREATED="1359643310097" ID="ID_871520906" MODIFIED="1397808360954" POSITION="right" TEXT="ref EXPR">
