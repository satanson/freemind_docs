...
<node CREATED="1362448669746" ID="ID_1994088080" MODIFIED="1362448681189" TEXT="make">
<node CREATED="1362448682869" FOLDED="true" ID="ID_657714606" MODIFIED="1362649912870" POSITION="right" TEXT="variable(macro)">
<node CREATED="1362463690835" ID="ID_930782766" MODIFIED="1362465867551" TEXT="intros">
<node CREATED="1362469428983" ID="ID_792856957" MODIFIED="1362469799885" TEXT="lhs">
<node CREATED="1362463161825" FOLDED="true" ID="ID_127806118" MODIFIED="1362469809105" TEXT="not containing &apos;:&apos;,&apos;#&apos;,&apos;=&apos;,leading or trailing ws">
<icon BUILTIN="full-1"/>
...
<node CREATED="1362463240204" FOLDED="true" ID="ID_697582111" MODIFIED="1362469808995" TEXT="[_A-Za-z0-9]+">
<icon BUILTIN="full-2"/>
...
<node CREATED="1362463475476" FOLDED="true" ID="ID_28377178" MODIFIED="1362469808995" TEXT="recommend">
<icon BUILTIN="full-4"/>
...
<node CREATED="1362469848103" FOLDED="true" ID="ID_920318327" MODIFIED="1362470101715" TEXT="computed variable name">
<icon BUILTIN="full-5"/>
...
<node CREATED="1362465870255" FOLDED="true" ID="ID_729986271" MODIFIED="1362470107628" TEXT="leading space">
<icon BUILTIN="full-1"/>
<node CREATED="1362465936961" ID="ID_275751512" MODIFIED="1362465939459" TEXT="ignored"/>
</node>
<node CREATED="1362465930354" FOLDED="true" ID="ID_1214431934" MODIFIED="1362470109297" TEXT="trailing space">
<icon BUILTIN="full-2"/>
<node CREATED="1362465947124" ID="ID_426658936" MODIFIED="1362465949388" TEXT="reserved"/>
</node>
</node>
</node>
<node CREATED="1362463701497" FOLDED="true" ID="ID_1863736280" MODIFIED="1362464736602" TEXT="variable references">
...
<node CREATED="1362463911522" FOLDED="true" ID="ID_928945609" MODIFIED="1362463962076" TEXT="$&lt;single-char&gt;">
...
<node CREATED="1362464737279" ID="ID_715399757" MODIFIED="1362472913872" TEXT="two flavors of variables">
<node CREATED="1362464791637" ID="ID_208248805" MODIFIED="1362465488407" TEXT="recursively expanded variables">
<icon BUILTIN="full-1"/>
...
<node CREATED="1362464882460" FOLDED="true" ID="ID_44718361" MODIFIED="1362465597007" TEXT="recursive expansion">
...
<node CREATED="1362464925532" FOLDED="true" ID="ID_450770661" MODIFIED="1362465203028" TEXT="disadvantages">
...
<node CREATED="1362465206934" ID="ID_92851409" MODIFIED="1362465221990" TEXT="simply expanded variables">
<icon BUILTIN="full-2"/>
...
<node CREATED="1362465403245" FOLDED="true" ID="ID_521549923" MODIFIED="1362465474048" TEXT="expansion at define-time and substituted verbatim">
...
<node CREATED="1362466347578" FOLDED="true" ID="ID_1087310666" MODIFIED="1362467689807" TEXT="substitution references">
<node CREATED="1362466473119" ID="ID_533610446" MODIFIED="1362466489813" TEXT="replace suffix of variables">
<node CREATED="1362466492362" FOLDED="true" ID="ID_508235846" MODIFIED="1362466702278" TEXT="${var:a=b} or $(var:a=b)">
...
<node CREATED="1362466586882" FOLDED="true" ID="ID_429522706" MODIFIED="1362466701357" TEXT="$(foo:%.o=%.c)">
<node CREATED="1362466677534" ID="ID_1434839687" MODIFIED="1362466699688" TEXT=" $(patsubst %.o,%.c,$(foo) )"/>
</node>
</node>
</node>
<node CREATED="1362467690328" FOLDED="true" ID="ID_867018545" MODIFIED="1362473262495" TEXT="nested variable references(computed variable name)">
...
<node CREATED="1362535075508" ID="ID_1419310372" MODIFIED="1362535084589" TEXT="define variable in makefile">
<node CREATED="1362473263904" FOLDED="true" ID="ID_730195096" MODIFIED="1362535070268" TEXT="setting variables">
...
<node CREATED="1362466086331" FOLDED="true" ID="ID_965260344" MODIFIED="1362466233271" TEXT="conditional variable assignment operator">
...
<node CREATED="1362473290682" FOLDED="true" ID="ID_895967523" MODIFIED="1362534618311" TEXT="+=">
...
<node CREATED="1362534385308" FOLDED="true" ID="ID_1081061885" MODIFIED="1362535062967" TEXT="Defining Multi-Line Variables">
<node CREATED="1362534570698" FOLDED="true" ID="ID_926648898" MODIFIED="1362534656782" TEXT="recursively">
...
<node CREATED="1362534579613" FOLDED="true" ID="ID_930630629" MODIFIED="1362534658373" TEXT="simply">
...
<node CREATED="1362534596032" FOLDED="true" ID="ID_491735440" MODIFIED="1362534660089" TEXT="conditional">
...
<node CREATED="1362534621296" FOLDED="true" ID="ID_1182148419" MODIFIED="1362534661789" TEXT="append">
...
<node CREATED="1362535088721" ID="ID_1083554523" MODIFIED="1362535092030" TEXT="undefine">
<node CREATED="1362535095687" ID="ID_1083570050" MODIFIED="1362535108715" TEXT="[override] undefine variable-name"/>
</node>
</node>
<node CREATED="1362535071662" FOLDED="true" ID="ID_148859908" MODIFIED="1362539021172" TEXT="precedence">
...
<node CREATED="1362539022977" FOLDED="true" ID="ID_1630056192" MODIFIED="1362540574228" TEXT="target-specific variable values">
...
<node CREATED="1362539597209" ID="ID_1533271649" MODIFIED="1362539962254" TEXT="can modfied by keywords:export,override,or private">
<icon BUILTIN="full-2"/>
...
<node CREATED="1362539656839" FOLDED="true" ID="ID_76443129" MODIFIED="1362539964465" TEXT="variable-assignment can be any form of assignment:=,:=,+=,?=">
<icon BUILTIN="full-3"/>
...
<node CREATED="1362539706138" FOLDED="true" ID="ID_560340836" MODIFIED="1362539968670" TEXT="the precedence of target same to makefile variables">
<icon BUILTIN="full-4"/>
...
<node CREATED="1362539755848" FOLDED="true" ID="ID_492948364" MODIFIED="1362539971589" TEXT="have impact on prerequisites of this target,ant all their prerequisites,etc">
<icon BUILTIN="full-5"/>
...
<node CREATED="1362539922314" FOLDED="true" ID="ID_1011090591" MODIFIED="1362539973468" TEXT="ignore the target-specific values from any other targes">
<icon BUILTIN="full-6"/>
...
<node CREATED="1362540123564" FOLDED="true" ID="ID_1456693756" MODIFIED="1362540218608" TEXT="pattern-specific variable values">
...
<node CREATED="1362540575460" ID="ID_416283148" MODIFIED="1362540780353" TEXT="variable modifier">
...
<node CREATED="1362540660636" ID="ID_380140419" MODIFIED="1362540674805" TEXT="target-specific variable">
...
<node CREATED="1362540774253" ID="ID_79362981" MODIFIED="1362649906970" TEXT="special variable">
<node CREATED="1362540896208" ID="ID_884946605" MODIFIED="1362540897524" TEXT="MAKEFILE_LIST">
...
<node CREATED="1362541319837" FOLDED="true" ID="ID_185644336" MODIFIED="1362541359816" TEXT=".RECIPEPREFIX">
...
<node CREATED="1362541414464" ID="ID_735761885" MODIFIED="1362541415487" TEXT=".VARIABLES">
...
<node CREATED="1362541440767" ID="ID_1990156971" MODIFIED="1362541441807" TEXT=".FEATURES">
...
<node CREATED="1362643672366" FOLDED="true" ID="ID_627912242" MODIFIED="1362649595312" POSITION="right" TEXT="string">
<node CREATED="1362647368640" FOLDED="true" ID="ID_1688388412" MODIFIED="1362647405302" TEXT="single-line">
<node CREATED="1362643681774" FOLDED="true" ID="ID_397127701" MODIFIED="1362647376996" TEXT="unquoted">
...
<node CREATED="1362461553429" FOLDED="true" ID="ID_901703431" MODIFIED="1362647376996" TEXT="quote">
...
<node CREATED="1362646608843" ID="ID_326775121" MODIFIED="1362646634710" TEXT="backslash-newline pair substitute by a space">
<icon BUILTIN="full-6"/>
...
<node CREATED="1362647381643" ID="ID_1832648668" MODIFIED="1362648891251" TEXT="multi-line">
...
<node CREATED="1362649613729" ID="ID_836152952" MODIFIED="1362649614904" POSITION="right" TEXT="rule">
...
<node CREATED="1362650072646" ID="ID_1973113254" MODIFIED="1362650072646" TEXT=""/>
</node>
<node CREATED="1362650035730" ID="ID_1966126585" MODIFIED="1362650035730" POSITION="right" TEXT=""/>
<node CREATED="1362448696540" FOLDED="true" ID="ID_1423638640" MODIFIED="1362649607793" POSITION="right" TEXT="function">
<node CREATED="1362448783932" ID="ID_1996234584" MODIFIED="1362448792304" TEXT="invocation">
<node CREATED="1362448794236" ID="ID_381615336" MODIFIED="1362448818144" TEXT="$(&lt;func_name&gt; args...)"/>
</node>
<node CREATED="1362448755958" ID="ID_633971272" MODIFIED="1362448764225" TEXT="built-in">
<node CREATED="1362448771485" ID="ID_625618380" MODIFIED="1362534818453" TEXT=" $(origin variable)  ">
<node CREATED="1362448948202" FOLDED="true" ID="ID_1705984364" MODIFIED="1362534821775" TEXT="variable">
...
<node CREATED="1362448955082" ID="ID_819920263" MODIFIED="1362448956948" TEXT="return">
<node CREATED="1362448958036" ID="ID_1852789531" MODIFIED="1362448965853" TEXT="&apos;undefined&apos;"/>
<node CREATED="1362448969499" FOLDED="true" ID="ID_385834362" MODIFIED="1362535617213" TEXT="&apos;default&apos;">
<node CREATED="1362449076249" FOLDED="true" ID="ID_845901546" MODIFIED="1362535616121" TEXT="default variable">
...
<node CREATED="1362449385872" FOLDED="true" ID="ID_1447724791" MODIFIED="1362449919014" TEXT="list all default variables">
<node CREATED="1362449404509" ID="ID_1757788372" MODIFIED="1362449410830" TEXT="make -p"/>
</node>
<node CREATED="1362451906121" FOLDED="true" ID="ID_1870875718" MODIFIED="1362452811440" TEXT="gcc/g++">
<node CREATED="1362452519854" FOLDED="true" ID="ID_1057433435" MODIFIED="1362452570365" TEXT="cpp">
<icon BUILTIN="full-1"/>
...
<node CREATED="1362452572409" FOLDED="true" ID="ID_1600698719" MODIFIED="1362452805581" TEXT="ccl">
<icon BUILTIN="full-2"/>
...
<node CREATED="1362452548825" FOLDED="true" ID="ID_1359772238" MODIFIED="1362452807398" TEXT="as">
<icon BUILTIN="full-3"/>
...
<node CREATED="1362457517932" FOLDED="true" ID="ID_456940301" MODIFIED="1362457606505" TEXT="&apos;file&apos;">
...
<node CREATED="1362457618438" FOLDED="true" ID="ID_304352145" MODIFIED="1362459953995" TEXT="&apos;automatic&apos;">
...
<node CREATED="1362458976315" FOLDED="true" ID="ID_1407011746" MODIFIED="1362459006139" TEXT="target">
...
<node CREATED="1362458990548" FOLDED="true" ID="ID_1463696404" MODIFIED="1362459005251" TEXT="target member(archive)">
...
<node CREATED="1362459008963" FOLDED="true" ID="ID_1835218528" MODIFIED="1362459057836" TEXT="first prerequisite">
...
<node CREATED="1362459040166" FOLDED="true" ID="ID_861169269" MODIFIED="1362459060946" TEXT="newer prerequisites">
...
<node CREATED="1362459130908" FOLDED="true" ID="ID_254382170" MODIFIED="1362459156826" TEXT="older prerequisites">
...
<node CREATED="1362458834547" ID="ID_763487778" MODIFIED="1362459146041" TEXT="$*">
<node CREATED="1362459147284" FOLDED="true" ID="ID_1490616289" MODIFIED="1362459155905" TEXT="stem of target">
...
<node CREATED="1362459469779" FOLDED="true" ID="ID_1496761342" MODIFIED="1362459946672" TEXT="semi-obsolete and dir/notdir get a similar effect">
<node CREATED="1362459516254" ID="ID_1759010877" MODIFIED="1362459554578" TEXT="$(dir names...)">
...
<node CREATED="1362534800791" ID="ID_281586" MODIFIED="1362534813133" TEXT="$(flavor variable)">
...
<node CREATED="1362540915572" ID="ID_591032804" MODIFIED="1362540940328" TEXT="$(patsubst old new variable)"/>
<node CREATED="1362540942073" ID="ID_1709638163" MODIFIED="1362540956597" TEXT="$(lastword variable)"/>
</node>
<node CREATED="1362448764458" ID="ID_868511459" MODIFIED="1362448769344" TEXT="user-defined"/>
</node>
<node CREATED="1362460396178" FOLDED="true" ID="ID_1272794560" MODIFIED="1362649610373" POSITION="right" TEXT="conditionals">
<node CREATED="1362460453899" ID="ID_913035734" MODIFIED="1362460500124" TEXT="ifeq,ifneq,ifdef,ifndef,else,endif">
<node CREATED="1362460511848" ID="ID_1970283145" MODIFIED="1362460989767">
<richcontent TYPE="NODE"><html>
  <head>
...
<node CREATED="1362461042335" FOLDED="true" ID="ID_1434039487" MODIFIED="1362461409148" TEXT="ifeq">
...
<node CREATED="1362461241920" FOLDED="true" ID="ID_116081627" MODIFIED="1362461407946" TEXT="ifneq">
<node CREATED="1362461390629" ID="ID_978969028" MODIFIED="1362461396558" TEXT="!ifeq"/>
</node>
<node CREATED="1362461165177" FOLDED="true" ID="ID_1138815545" MODIFIED="1362461406807" TEXT="ifdef">
