...
<node CREATED="1341477637979" FOLDED="true" ID="ID_1696978992" MODIFIED="1342491536753" POSITION="right" TEXT="debugging multithreaded program">
...
<node CREATED="1341477663455" FOLDED="true" ID="ID_328407696" MODIFIED="1352207757498" POSITION="right" TEXT="debug shared library">
...
<node CREATED="1341542109222" FOLDED="true" ID="ID_374195740" MODIFIED="1357390637269" POSITION="right" TEXT="glibc(GNU C Library) (C Posix Library)">
...
<node CREATED="1342491538372" ID="ID_937411553" MODIFIED="1358146906116" POSITION="right" TEXT="gdb in action">
<font BOLD="true" NAME="&#x5fae;&#x8f6f;&#x96c5;&#x9ed1;" SIZE="16"/>
<node CREATED="1342492210013" ID="ID_558162991" MODIFIED="1357390644242" TEXT="loading program">
...
<node CREATED="1342494834532" ID="ID_1432005787" MODIFIED="1342494910955" TEXT="running program">
...
<node CREATED="1342494874623" ID="ID_246872619" MODIFIED="1356403864228" TEXT="examining data">
...
<node CREATED="1342495014743" ID="ID_407982420" MODIFIED="1342507776882" TEXT="print -  examining data value">
...
<node CREATED="1342508373921" ID="ID_1954902512" MODIFIED="1356403872096" TEXT="examining memory">
<node CREATED="1342507717590" ID="ID_245939853" MODIFIED="1352206751996" TEXT="x -  examining memory">
...
<node CREATED="1342494920143" ID="ID_1164574638" MODIFIED="1357390779096" TEXT="examining source">
<node CREATED="1342509531663" ID="ID_1417871848" MODIFIED="1342509542577" TEXT="list - list source">
...
<node CREATED="1342513209146" ID="ID_1691406863" MODIFIED="1357390820281" TEXT="examining stack">
<node CREATED="1342513221629" ID="ID_145516633" MODIFIED="1355285241706" TEXT="-fomit-frame-pointer (GCC option)">
...
<node CREATED="1342514979880" ID="ID_836839732" MODIFIED="1342516369547" TEXT="bt|backtrace|where|info s|info stack ">
...
<node CREATED="1356350195664" ID="ID_944430434" MODIFIED="1357390828861" TEXT="signal">
...
<node CREATED="1356352108430" FOLDED="true" ID="ID_202322062" MODIFIED="1357390891697" TEXT="signal(kill -l)">
...
<node CREATED="1356403586580" ID="ID_1004819643" MODIFIED="1356403591310" TEXT="set">
...
<node CREATED="1342530828177" ID="ID_1559682088" MODIFIED="1357390897204" TEXT="breakpoint">
...
<node CREATED="1342532613686" ID="ID_84224475" MODIFIED="1342532617288" TEXT="thbreak">
...
<node CREATED="1342532794169" ID="ID_1202608051" MODIFIED="1342532816911" TEXT="info break[points] n">
...
<node CREATED="1342530818308" ID="ID_288025453" MODIFIED="1342530846399" TEXT="watchpoint"/>
