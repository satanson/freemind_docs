...
<node CREATED="1359821441013" ID="ID_121270593" MODIFIED="1456573209397" TEXT="lisp">
...
<node CREATED="1359903276243" ID="ID_238582966" MODIFIED="1359903284457" TEXT="Quoted forms">
<node CREATED="1359828484950" ID="ID_47839386" MODIFIED="1359903287499" TEXT="quote special operator, or its abbreviation &apos;"/>
<node CREATED="1359828598276" ID="ID_1794805609" MODIFIED="1359828606148" TEXT="backquote `">
<node CREATED="1359828607697" ID="ID_1002052974" MODIFIED="1359903807688" TEXT="allows expressions to be evaluated and their values interpolated into a quoted list with the comma and comma-at operators."/>
</node>
</node>
</node>
<node CREATED="1359828076309" ID="ID_434322956" MODIFIED="1425539281865" TEXT="Shared structure">
<node CREATED="1359828166744" ID="ID_437993919" MODIFIED="1359828167807" TEXT="two lists can have the same tail, or final sequence of conses."/>
<node CREATED="1359828146935" ID="ID_1461021827" MODIFIED="1359893680066" TEXT="(setf foo (list &apos;a &apos;b &apos;c)) (setf bar (cons &apos;x (cdr foo)))">
<node CREATED="1359893558718" ID="ID_1417218943" MODIFIED="1359893581830" TEXT="clisp"/>
</node>
<node CREATED="1359893582886" ID="ID_26032852" MODIFIED="1359893654321" TEXT="(define foo (list &apos;a &apos;b &apos;c)) (define bar (cons &apos;x (cdr foo)))">
<node CREATED="1359893682104" ID="ID_845969907" MODIFIED="1359893685141" TEXT="scheme"/>
</node>
</node>
</node>
<node CREATED="1359827469399" ID="ID_1060917790" MODIFIED="1359887504392" TEXT="A proper list is either the special nil (empty list) symbol, or a cons in which the car points to a datum (which may be another cons structure, such as a list), and the cdr points to another proper list."/>
</node>
<node CREATED="1359826665134" ID="ID_1207873157" MODIFIED="1425539286753" TEXT="Operator">
<node CREATED="1359826669934" ID="ID_1888412515" MODIFIED="1359826680039" TEXT="Polish prefix"/>
...
<node CREATED="1359828310581" ID="ID_1693888042" MODIFIED="1359828312888" TEXT="&apos;">
<node CREATED="1359828316048" ID="ID_1553175846" MODIFIED="1359828317151" TEXT="quote">
<node CREATED="1359828337469" ID="ID_1429781856" MODIFIED="1359828341556" TEXT="prevents the quoted arguments from being evaluated"/>
</node>
</node>
</node>
</node>
<node CREATED="1359826832413" ID="ID_1347502157" MODIFIED="1388795486963" TEXT="Lambda(&#x3bb;) expression">
<node CREATED="1359826983921" ID="ID_1664527510" MODIFIED="1359887644073" TEXT="((lambda (arg) (+ arg 1)) 5)">
<node CREATED="1359826996070" ID="ID_1635605008" MODIFIED="1359826997081" TEXT="evaluates to 6"/>
</node>
</node>
<node CREATED="1359828901702" ID="ID_815143959" MODIFIED="1388796607389" TEXT="Scope and closure">
<node CREATED="1359904042322" ID="ID_1664047916" MODIFIED="1359904051017" TEXT="Scope">
<node CREATED="1359904052389" ID="ID_1666069000" MODIFIED="1359904077238" TEXT="dynamic scoping"/>
<node CREATED="1359904077564" ID="ID_1697262845" MODIFIED="1359904091644" TEXT="static(lexical) scoping"/>
</node>
<node CREATED="1359904093011" ID="ID_914954033" MODIFIED="1359904096807" TEXT="closure"/>
</node>
...
<node CREATED="1359905099372" ID="ID_1522415533" MODIFIED="1359905100574" TEXT="eval"/>
<node CREATED="1359905100854" ID="ID_1226182007" MODIFIED="1359905101745" TEXT="read"/>
</node>
</node>
</node>
</node>
...
<node CREATED="1359949171148" ID="ID_1442649830" MODIFIED="1359949172459" TEXT="(define factorial (lambda (n) (cond ((&lt;= n 1) 1) (else (* n (factorial(- n 1)))))))">
<node CREATED="1359999534518" ID="ID_168351172" MODIFIED="1359999537180" TEXT="scheme">
<node CREATED="1359999594080" ID="ID_1207268899" MODIFIED="1359999615772" TEXT="(cond ((test-form) form) (else form))"/>
</node>
</node>
<node CREATED="1359999515525" ID="ID_161625596" MODIFIED="1359999517318" TEXT="(defun ff(x) (cond ((atom x) x) ((ff (car x)))))">
<node CREATED="1359999543061" ID="ID_633263478" MODIFIED="1359999546054" TEXT="clisp">
<node CREATED="1359999548132" ID="ID_1067699424" MODIFIED="1359999584280" TEXT="(cond ((test-form) form) ((form))"/>
</node>
</node>
</node>
...
<node CREATED="1359907829086" ID="ID_790163241" MODIFIED="1421341784092" TEXT="loop">
<node CREATED="1359829336393" ID="ID_29691798" MODIFIED="1359909408264" TEXT="tail recursion (scheme)">
<node CREATED="1359829378383" ID="ID_1943881907" MODIFIED="1359829379460" TEXT="tail call">
<node CREATED="1359829380560" ID="ID_1978138675" MODIFIED="1359829383157" TEXT="do loop"/>
</node>
</node>
<node CREATED="1359909346460" ID="ID_652185974" MODIFIED="1388822303482" TEXT="do-loop">
<node CREATED="1359909373902" ID="ID_735748423" MODIFIED="1359909376865" TEXT="scheme"/>
</node>
<node CREATED="1359909377696" ID="ID_1845567756" MODIFIED="1359909378967" TEXT="loop">
<node CREATED="1359909379973" ID="ID_775460016" MODIFIED="1359909382738" TEXT="clisp"/>
</node>
</node>
</node>
</node>
<node CREATED="1425793866599" ID="ID_1818894155" MODIFIED="1456558488602" POSITION="right" TEXT="R5RS">
<node CREATED="1425798501490" ID="ID_635404488" MODIFIED="1430452716436" TEXT="data">
...
<node CREATED="1425799551853" ID="ID_1959306749" MODIFIED="1425799557196" TEXT="and or not"/>
</node>
<node CREATED="1425798934189" ID="ID_1192776770" MODIFIED="1425799209973" TEXT="char #\A">
<node CREATED="1425799568488" ID="ID_1442906723" MODIFIED="1425799601626" TEXT="char-{downcase, upcase} "/>
</node>
<node CREATED="1425798940530" ID="ID_1691462635" MODIFIED="1425799971092" TEXT="number #x #d #o #b #i #e">
<node CREATED="1425799609798" ID="ID_582672612" MODIFIED="1425799623385" TEXT="real"/>
<node CREATED="1425799623857" FOLDED="true" ID="ID_213547994" MODIFIED="1425799972227" TEXT="complex">
<node CREATED="1425796406568" ID="ID_1975739829" MODIFIED="1425798160551" TEXT="magnitude"/>
<node CREATED="1425798161646" ID="ID_149448294" MODIFIED="1425798162870" TEXT="angle"/>
<node CREATED="1425795189179" ID="ID_863930507" MODIFIED="1425796754268" TEXT="real-part imag-part"/>
<node CREATED="1425798174925" ID="ID_460504469" MODIFIED="1425798180508" TEXT="make-rectangle"/>
<node CREATED="1425798180842" ID="ID_355481824" MODIFIED="1425798183804" TEXT="make-polar"/>
</node>
<node CREATED="1425799690187" FOLDED="true" ID="ID_854001075" MODIFIED="1425799974555" TEXT="rational">
<node CREATED="1425795208437" ID="ID_1081678326" MODIFIED="1425795212479" TEXT="rationalize"/>
<node CREATED="1425795535052" ID="ID_770941292" MODIFIED="1425799817552" TEXT="numerator denominator"/>
<node CREATED="1425795538801" ID="ID_1605133600" MODIFIED="1425799917217" TEXT="truncate round floor ceiling"/>
</node>
<node CREATED="1425799626157" ID="ID_191404997" MODIFIED="1425799628512" TEXT="integer"/>
</node>
<node CREATED="1425798982000" FOLDED="true" ID="ID_1541003799" MODIFIED="1425800027546" TEXT="string &quot;&quot;">
<node CREATED="1425794784652" ID="ID_455687229" MODIFIED="1425800006149" TEXT="string"/>
<node CREATED="1425794784654" ID="ID_649887064" MODIFIED="1425794819210" TEXT="string-append"/>
<node CREATED="1425794784658" ID="ID_1669348630" MODIFIED="1425794934963" TEXT="string-copy"/>
<node CREATED="1425794784658" ID="ID_866817137" MODIFIED="1425794937893" TEXT="string-fill!"/>
<node CREATED="1425794784659" ID="ID_1621357966" MODIFIED="1425794945735" TEXT="string-length"/>
<node CREATED="1425794784660" ID="ID_1164823575" MODIFIED="1425794947416" TEXT="string-ref"/>
<node CREATED="1425794784660" ID="ID_29194451" MODIFIED="1425794952525" TEXT="string-set!"/>
<node CREATED="1425794784664" ID="ID_992751722" MODIFIED="1425800010122" TEXT="substring"/>
<node CREATED="1425800022910" ID="ID_314518926" MODIFIED="1425800024723" TEXT="make-string"/>
</node>
<node CREATED="1425798966571" ID="ID_1888467269" MODIFIED="1425799209970" TEXT="symbol &apos;">
<node CREATED="1425801034607" ID="ID_1244565223" MODIFIED="1425801040608" TEXT="quote"/>
</node>
<node CREATED="1425798974274" FOLDED="true" ID="ID_127977347" MODIFIED="1425801060694" TEXT="list &apos;()">
<node CREATED="1425794394945" ID="ID_1395408148" MODIFIED="1425800073595" TEXT="quote &apos;"/>
<node CREATED="1425794400081" ID="ID_908097073" MODIFIED="1425800073594" TEXT="quasiquote `"/>
<node CREATED="1425794410589" ID="ID_1761221066" MODIFIED="1425800073594" TEXT="unquote ,"/>
<node CREATED="1425794412817" ID="ID_313494917" MODIFIED="1425800073593" TEXT="unquote-splicing ,@"/>
<node CREATED="1425795139141" ID="ID_1634159059" MODIFIED="1425800073592" TEXT="reverse"/>
<node CREATED="1425796207278" ID="ID_1161467571" MODIFIED="1425800073591" TEXT="memq (eq?) memv(eqv?) member(equal?)"/>
<node CREATED="1425798311757" ID="ID_1303945257" MODIFIED="1425800073590" TEXT="assq assv assoc"/>
<node CREATED="1425796350624" ID="ID_548298270" MODIFIED="1425800073589" TEXT="map"/>
<node CREATED="1425796439665" ID="ID_1751921827" MODIFIED="1425800073588" TEXT="list"/>
<node CREATED="1425796541204" ID="ID_461896283" MODIFIED="1425796542526" TEXT="list-ref"/>
<node CREATED="1425796542756" ID="ID_1585247373" MODIFIED="1425796544659" TEXT="list-tail"/>
<node CREATED="1425796692502" ID="ID_666589999" MODIFIED="1425796694262" TEXT="length"/>
<node CREATED="1425796940160" ID="ID_1048674885" MODIFIED="1425796942352" TEXT="for-each"/>
<node CREATED="1425797250617" ID="ID_1758269381" MODIFIED="1425797815911" TEXT="car cdr cons cadr cddr caddr cdddr cadddr cddddr"/>
</node>
<node CREATED="1425798976922" ID="ID_1511290102" MODIFIED="1425799209968" TEXT="vector &apos;#()">
<node CREATED="1425794327880" ID="ID_1130066352" MODIFIED="1425794331449" TEXT="vector-&gt;list"/>
<node CREATED="1425794331698" ID="ID_146365554" MODIFIED="1425794334980" TEXT="vector-set!"/>
<node CREATED="1425794335299" ID="ID_599619748" MODIFIED="1425794338759" TEXT="vector-fill!"/>
<node CREATED="1425794338994" ID="ID_1018352332" MODIFIED="1425794342264" TEXT="vector-ref"/>
<node CREATED="1425794351391" ID="ID_1915999826" MODIFIED="1425794354144" TEXT="vector-length"/>
<node CREATED="1425800125262" ID="ID_929133739" MODIFIED="1425800129018" TEXT="make-vector"/>
</node>
</node>
<node CREATED="1425799212451" FOLDED="true" ID="ID_733184986" MODIFIED="1425800146031" TEXT="type conv -&gt; &lt;-&gt; means bidirectional conv">
<node CREATED="1425799235056" ID="ID_859375841" MODIFIED="1425799295858" TEXT="symbol &lt;-&gt;string"/>
<node CREATED="1425799296493" ID="ID_1296704899" MODIFIED="1425799340983" TEXT="string&lt;-&gt;list"/>
<node CREATED="1425799369915" ID="ID_767268142" MODIFIED="1425799395906" TEXT="string&lt;-&gt;number"/>
<node CREATED="1425799419373" ID="ID_1091156282" MODIFIED="1425799424090" TEXT="list&lt;-&gt;vector"/>
<node CREATED="1425799475938" ID="ID_463088566" MODIFIED="1425799481867" TEXT="integer&lt;-&gt;char"/>
<node CREATED="1425799496105" ID="ID_247454549" MODIFIED="1425799502556" TEXT="exact&lt;-&gt;inexact"/>
</node>
</node>
<node CREATED="1425796851585" ID="ID_1818106978" MODIFIED="1430452668482" TEXT="if case cond else">
<node CREATED="1425800148319" ID="ID_679574732" MODIFIED="1430452670775" TEXT="test?">
<node CREATED="1425800222044" ID="ID_1601393350" MODIFIED="1425800227772" TEXT="boolean?">
<node CREATED="1425800347642" ID="ID_97947164" MODIFIED="1425800358670" TEXT="#f #t and or not"/>
</node>
<node CREATED="1425800211930" ID="ID_1008444638" MODIFIED="1425800676735" TEXT="char?">
<node CREATED="1425800402546" ID="ID_574153635" MODIFIED="1425800645891" TEXT="char-ci-{&lt;, &gt;, =, &lt;=, &gt;=}?  ;case-insensitive"/>
<node CREATED="1425800431589" ID="ID_993931570" MODIFIED="1425800653229" TEXT="char{&lt;. &gt;, =, &lt;=, &gt;=}?; case-sensitive"/>
<node CREATED="1425797402535" ID="ID_1131287412" MODIFIED="1425797446734" TEXT="char-{alphabetic, lower-case, upper-case, whitespace, numeric} ?"/>
</node>
<node CREATED="1425800197316" ID="ID_1351495709" MODIFIED="1430452742488" TEXT="number?">
<node CREATED="1425800502486" ID="ID_1269603305" MODIFIED="1425800511909" TEXT="integer?">
<node CREATED="1425800620982" ID="ID_1343149456" MODIFIED="1425800626778" TEXT="odd? even?"/>
</node>
<node CREATED="1425800518594" ID="ID_345360026" MODIFIED="1425800528114" TEXT="rational?"/>
<node CREATED="1425800528596" ID="ID_1291417377" MODIFIED="1425800537313" TEXT="real?"/>
<node CREATED="1425800537694" ID="ID_677796335" MODIFIED="1425800541036" TEXT="complex?"/>
<node CREATED="1425800549630" ID="ID_1393528772" MODIFIED="1425800557645" TEXT="exact? inexact?"/>
<node CREATED="1425800557892" ID="ID_1625500486" MODIFIED="1425800601011" TEXT="negative? zero? positive?"/>
</node>
<node CREATED="1425800201953" ID="ID_1343601600" MODIFIED="1425800211445" TEXT="symbol?"/>
<node CREATED="1425800310891" ID="ID_1312033041" MODIFIED="1425800312729" TEXT="string?">
<node CREATED="1425800402546" ID="ID_37230924" MODIFIED="1425800464553" TEXT="string-ci-{&lt;, &gt;, =, &lt;=, &gt;=}?  ;case-insensitive"/>
<node CREATED="1425800431589" ID="ID_899307770" MODIFIED="1425800476078" TEXT="string{&lt;. &gt;, =, &lt;=, &gt;=}?; case-sensitive"/>
</node>
<node CREATED="1425800234385" ID="ID_1241483710" MODIFIED="1425800249798" TEXT="list?">
<node CREATED="1425800367488" ID="ID_922290832" MODIFIED="1425800381682" TEXT="null? pair?"/>
</node>
<node CREATED="1425800250241" ID="ID_1595939607" MODIFIED="1425800252454" TEXT="vector?"/>
<node CREATED="1425800329088" ID="ID_1572362824" MODIFIED="1425800333345" TEXT="procedure?"/>
<node CREATED="1425800833958" ID="ID_1179314968" MODIFIED="1425800834869" TEXT="eq? eqv? equal? ">
<node CREATED="1425801806486" ID="ID_266986323" MODIFIED="1425801938655" TEXT="(eq? x y)  =&gt; (eqv? x y)  =&gt; (equal? x y)  "/>
</node>
</node>
<node CREATED="1425802035100" ID="ID_689727826" MODIFIED="1425802166347" TEXT="case  ;eqv?"/>
</node>
<node CREATED="1425798375382" ID="ID_1663301392" MODIFIED="1456558495639" TEXT="define  set! lambda let">
<node CREATED="1425797206763" ID="ID_667595329" MODIFIED="1456558497238" TEXT="define">
<node CREATED="1425804295664" ID="ID_1292104910" MODIFIED="1425804311747" TEXT="(define (foobar x . y) y)">
<node CREATED="1425804333687" ID="ID_891115005" MODIFIED="1425804346321" TEXT="(foobar 1 2 3); (2 3)"/>
</node>
<node CREATED="1425804347132" ID="ID_1806364048" MODIFIED="1425804358689" TEXT="(define (foobar . y) (car y))">
<node CREATED="1425804362964" ID="ID_1593552333" MODIFIED="1425804377162" TEXT="(foobar 1 2 3); 1"/>
</node>
</node>
<node CREATED="1425796614095" ID="ID_1073162000" MODIFIED="1425796622568" TEXT="let* let letrec"/>
<node CREATED="1425795060083" ID="ID_496101236" MODIFIED="1425798453933" TEXT="set!"/>
<node CREATED="1425795061575" ID="ID_806027463" MODIFIED="1425798453932" TEXT="set-car!"/>
<node CREATED="1425795066244" ID="ID_502925624" MODIFIED="1425798453931" TEXT="set-cdr!"/>
<node CREATED="1425795072779" ID="ID_1331847294" MODIFIED="1425798453929" TEXT="setcar"/>
</node>
<node CREATED="1425794605447" FOLDED="true" ID="ID_1204652944" MODIFIED="1425804266437" TEXT="math">
<node CREATED="1425794611462" ID="ID_758130620" MODIFIED="1425796036396" TEXT="tan sin cos atan asin acos"/>
<node CREATED="1425794987000" ID="ID_76477496" MODIFIED="1425796092943" TEXT="sqrt exp log expt"/>
<node CREATED="1425795999986" ID="ID_1104461022" MODIFIED="1425796004099" TEXT="min max"/>
<node CREATED="1425796640704" ID="ID_306789591" MODIFIED="1425796643263" TEXT="gcd lcm"/>
<node CREATED="1425798067687" ID="ID_1698462793" MODIFIED="1425798068910" TEXT="abs"/>
<node CREATED="1425795114681" ID="ID_608024112" MODIFIED="1425798245930" TEXT="round floor ceiling"/>
<node CREATED="1425795153977" ID="ID_158210672" MODIFIED="1425798245931" TEXT="quotient modulo reminder"/>
</node>
<node CREATED="1425823414844" ID="ID_685254545" MODIFIED="1425823429360" TEXT="meta-programming">
<node CREATED="1425823432772" ID="ID_1170979544" MODIFIED="1425823775325" TEXT="primary expressions">
<node CREATED="1425823458004" ID="ID_726997707" MODIFIED="1425823487199" TEXT="define "/>
<node CREATED="1425823464860" ID="ID_481854642" MODIFIED="1425823490874" TEXT="quote &apos;"/>
<node CREATED="1425823493767" ID="ID_83591635" MODIFIED="1425823499814" TEXT="lambda"/>
<node CREATED="1425823500082" ID="ID_1342382686" MODIFIED="1425823504901" TEXT="if else"/>
<node CREATED="1425823507312" ID="ID_1698443808" MODIFIED="1425823515165" TEXT="set!"/>
<node CREATED="1425823661899" ID="ID_1810504950" MODIFIED="1425823770293" TEXT="combination; function call"/>
</node>
<node CREATED="1425794702200" FOLDED="true" ID="ID_957374844" MODIFIED="1425823430325" TEXT="macro">
<node CREATED="1425797201374" ID="ID_806265793" MODIFIED="1425804256921" TEXT="define-syntax"/>
<node CREATED="1425796581562" ID="ID_866782576" MODIFIED="1425796585878" TEXT="let-syntax"/>
<node CREATED="1425796586150" ID="ID_1986209170" MODIFIED="1425796591341" TEXT="letrec-syntax"/>
<node CREATED="1425794705252" ID="ID_1111453849" MODIFIED="1425804255246" TEXT="syntax-rules"/>
<node CREATED="1425818782642" ID="ID_532645648" MODIFIED="1425818794251" TEXT="syntax-case;R6RS"/>
</node>
</node>
<node CREATED="1425793940694" FOLDED="true" ID="ID_446662202" MODIFIED="1425823649301" TEXT="io">
<node CREATED="1425793942433" ID="ID_1660824129" MODIFIED="1425793944073" TEXT="file">
<node CREATED="1425793953180" ID="ID_630291233" MODIFIED="1425793987323" TEXT="write"/>
<node CREATED="1425793987553" ID="ID_402884094" MODIFIED="1425793989617" TEXT="write-char"/>
<node CREATED="1425795221508" ID="ID_270249430" MODIFIED="1425804998180" TEXT="read"/>
<node CREATED="1425795222889" ID="ID_1860562483" MODIFIED="1425804995540" TEXT="read-char"/>
<node CREATED="1425795303411" ID="ID_402234789" MODIFIED="1425805006333" TEXT="peek-char"/>
<node CREATED="1425797166664" ID="ID_1261411246" MODIFIED="1425805011997" TEXT="display"/>
<node CREATED="1425797402537" ID="ID_351964319" MODIFIED="1425805015893" TEXT="char-ready?"/>
<node CREATED="1425793997638" ID="ID_1065394937" MODIFIED="1425794002075" TEXT="with-input-from-file"/>
<node CREATED="1425794009673" ID="ID_1089474265" MODIFIED="1425794013288" TEXT="with-output-to-file"/>
<node CREATED="1425795295190" ID="ID_431679116" MODIFIED="1425795404389" TEXT="{output, input}-port?  port?"/>
<node CREATED="1425795456228" ID="ID_515449455" MODIFIED="1425795470086" TEXT="open-{output, input}-file"/>
<node CREATED="1425796496579" ID="ID_622028139" MODIFIED="1425796497389" TEXT="load"/>
<node CREATED="1425797072630" ID="ID_1776320787" MODIFIED="1425797075466" TEXT="eof-object?"/>
<node CREATED="1425797222102" ID="ID_763117660" MODIFIED="1425797233787" TEXT="current-{input, output}-port"/>
<node CREATED="1425797309873" ID="ID_8422231" MODIFIED="1425797317672" TEXT="close-{input, output}-port"/>
<node CREATED="1425795982829" ID="ID_395772643" MODIFIED="1425798468592" TEXT="newline"/>
</node>
<node CREATED="1425793944288" ID="ID_1485722007" MODIFIED="1425793948854" TEXT="std">
<node CREATED="1425793949856" ID="ID_975734797" MODIFIED="1425793949856" TEXT=""/>
</node>
</node>
<node CREATED="1425795237423" ID="ID_1284668274" MODIFIED="1425823658021" TEXT="procedure">
<node CREATED="1425797141707" ID="ID_1375943328" MODIFIED="1425797145652" TEXT="dynamic-wind"/>
<node CREATED="1425797186152" ID="ID_1009480134" MODIFIED="1425797188694" TEXT="delay"/>
<node CREATED="1425797886466" ID="ID_1975430074" MODIFIED="1425797894438" TEXT="call/cc"/>
<node CREATED="1425797894925" ID="ID_1829250798" MODIFIED="1425797903067" TEXT="call-with-values"/>
<node CREATED="1425797908396" ID="ID_1755530583" MODIFIED="1425797911904" TEXT="call-with-input-file"/>
<node CREATED="1425797918164" ID="ID_521356616" MODIFIED="1425797946252" TEXT="call-with-output-file"/>
<node CREATED="1425797962367" ID="ID_91875417" MODIFIED="1425797973173" TEXT="call-with-current-continuation"/>
<node CREATED="1425823640117" ID="ID_1082979022" MODIFIED="1425823655000" TEXT="values"/>
<node CREATED="1425797830537" ID="ID_1509874474" MODIFIED="1425798398821" TEXT="catch"/>
</node>
<node CREATED="1425794049708" FOLDED="true" ID="ID_954595028" MODIFIED="1425818774505" TEXT="misc">
<node CREATED="1425794361351" ID="ID_750492908" MODIFIED="1425794364140" TEXT="values"/>
<node CREATED="1425794573554" ID="ID_414510754" MODIFIED="1425794595515" TEXT="transcript-{on, off}"/>
<node CREATED="1425795086860" ID="ID_1499101675" MODIFIED="1425795104322" TEXT="scheme-report-environment"/>
<node CREATED="1425795974343" ID="ID_470514089" MODIFIED="1425795980965" TEXT="null-environment"/>
<node CREATED="1425796729758" ID="ID_1075381451" MODIFIED="1425796736357" TEXT="interactive-environment"/>
<node CREATED="1425796918958" ID="ID_1889714444" MODIFIED="1425796920895" TEXT="force"/>
...
<node CREATED="1428853738697" FOLDED="true" ID="ID_1642075337" MODIFIED="1439734949141" POSITION="right" TEXT="clisp">
<node CREATED="1428940312189" ID="ID_968221431" MODIFIED="1437322708209" TEXT="data">
<node CREATED="1428940315701" ID="ID_1923638940" MODIFIED="1437322618227" TEXT="boolean T/NIL">
<node CREATED="1428854134561" ID="ID_955084651" MODIFIED="1428940322434" TEXT="T/nil  ; #t/#f "/>
</node>
<node CREATED="1428940324496" FOLDED="true" ID="ID_225200071" MODIFIED="1437322635801" TEXT="&apos;symbol">
<node CREATED="1428854439306" ID="ID_45404396" MODIFIED="1428940431079" TEXT="&apos;symbol ; &apos;symbol">
<node CREATED="1428854456675" ID="ID_1058860824" MODIFIED="1437060146824" TEXT="symbol-value">
...
<node CREATED="1428940349389" FOLDED="true" ID="ID_194666523" MODIFIED="1437322651226" TEXT="(list)">
...
<node CREATED="1428855705349" ID="ID_597720926" MODIFIED="1437060334931" TEXT="sort ; sort">
...
<node CREATED="1437322652082" ID="ID_1211781020" MODIFIED="1437322657143" TEXT="#\Char"/>
<node CREATED="1437322657510" ID="ID_725672211" MODIFIED="1437322692646" TEXT="#c(real-part image-part)"/>
<node CREATED="1437322692982" ID="ID_1494592308" MODIFIED="1437322703467" TEXT="&quot;string&quot;"/>
</node>
<node CREATED="1437319612171" FOLDED="true" ID="ID_1371193306" MODIFIED="1439010978115" TEXT="set setq setf replica replicd">
<node CREATED="1437319799904" ID="ID_14874038" MODIFIED="1437319820457" TEXT="set symbol">
<node CREATED="1437319901173" ID="ID_91044929" MODIFIED="1437319937232" TEXT="(set &apos;a &apos;(1 2 3))"/>
<node CREATED="1437319909601" ID="ID_77069668" MODIFIED="1437319945229" TEXT="(set (quote a) 1(1 2 3))"/>
<node CREATED="1437319918126" ID="ID_1570142402" MODIFIED="1437319955100" TEXT="(set a 10); WRONG "/>
<node CREATED="1437319955515" ID="ID_635221121" MODIFIED="1437319965341" TEXT="(set (car a) 10); WRONG"/>
</node>
<node CREATED="1437319820734" ID="ID_55122042" MODIFIED="1437319838238" TEXT="setq variable">
<node CREATED="1437319967550" ID="ID_841081295" MODIFIED="1437319980469" TEXT="(setq a &apos;(1 2 3))"/>
<node CREATED="1437319980773" ID="ID_1033407149" MODIFIED="1437319994979" TEXT="(setq &apos;a &apos;(1 2 3));WRONG"/>
<node CREATED="1437319918126" ID="ID_1484863684" MODIFIED="1437320005202" TEXT="(setq a 10); WRONG "/>
<node CREATED="1437319955515" ID="ID_731364695" MODIFIED="1437320007533" TEXT="(setq (car a) 10); WRONG"/>
</node>
<node CREATED="1437319857660" ID="ID_1052197758" MODIFIED="1437319871238" TEXT="replica set-car!">
<node CREATED="1437320010818" ID="ID_1880540322" MODIFIED="1437320049594" TEXT="(replica a 2)"/>
</node>
<node CREATED="1437319872027" ID="ID_1690938511" MODIFIED="1437319877363" TEXT="replicd set-cdr!">
<node CREATED="1437320053621" ID="ID_802455580" MODIFIED="1437320064775" TEXT="(replicd a NIL)"/>
</node>
<node CREATED="1437319879730" ID="ID_1840929020" MODIFIED="1437320369698" TEXT="setf macro">
<node CREATED="1437320068350" ID="ID_1054496630" MODIFIED="1437320079925" TEXT="(setf  a &apos;(1 2 3))"/>
<node CREATED="1437320080236" ID="ID_457232881" MODIFIED="1437320093227" TEXT="(setf a &apos;(1 2 3))"/>
<node CREATED="1437320086381" ID="ID_357167747" MODIFIED="1437320111723" TEXT="(setf (car a) 2)"/>
<node CREATED="1437320112026" ID="ID_1696421680" MODIFIED="1437320119430" TEXT="(setf (cdr a) NIL)"/>
</node>
</node>
<node CREATED="1437321352325" ID="ID_418958848" MODIFIED="1439648056523" TEXT="eq eql equal equalp">
<node CREATED="1437321363402" ID="ID_803940320" MODIFIED="1437321369609" TEXT="eq  same object">
<node CREATED="1437322139849" ID="ID_1076938441" MODIFIED="1437322326473" TEXT="(eq 2 2)=&gt;NIL"/>
<node CREATED="1437322149524" ID="ID_1306972350" MODIFIED="1437322332864" TEXT="(eq 2.0 2.0)=&gt;NIL"/>
<node CREATED="1437322213756" ID="ID_124941965" MODIFIED="1437322340412" TEXT="(eq #\A #\A)=&gt;NIL"/>
<node CREATED="1437322361893" ID="ID_51570025" MODIFIED="1437322402148" TEXT="(eq &apos;(1 2 (3 4) &apos;(1 2 (3 4))=&gt;NIL"/>
</node>
<node CREATED="1437321370072" ID="ID_565603675" MODIFIED="1439648112455" TEXT="eql (eq a b) | same numerals and characters">
<node CREATED="1437322122063" ID="ID_84880519" MODIFIED="1437322139425" TEXT="(eql &quot;ab&quot; &quot;ab&quot;)=&gt;NIL"/>
<node CREATED="1437322139849" ID="ID_1636849041" MODIFIED="1437322186182" TEXT="(eql 2 2)=&gt;T"/>
<node CREATED="1437322149524" ID="ID_815771452" MODIFIED="1437322188023" TEXT="(eql 2.0 2.0)=&gt;T"/>
<node CREATED="1437322213756" ID="ID_38873174" MODIFIED="1437322242417" TEXT="(eql #\A #\A)=&gt;T"/>
<node CREATED="1437322103007" ID="ID_319445838" MODIFIED="1437322298184" TEXT="(eql 2 2.0) =&gt;NIL"/>
<node CREATED="1437322159989" ID="ID_920208033" MODIFIED="1437322181191" TEXT="(eql #\A #\a)=&gt;NIL"/>
<node CREATED="1437322361893" ID="ID_546571179" MODIFIED="1437322414842" TEXT="(eql &apos;(1 2 (3 4) &apos;(1 2 (3 4))=&gt;NIL"/>
</node>
<node CREATED="1437321693343" ID="ID_1488520540" MODIFIED="1439648106623" TEXT="equal (eql a b) | same string and list">
<node CREATED="1437322103007" ID="ID_1341795073" MODIFIED="1437322347513" TEXT="(equal 2 2.0) =&gt;NIL"/>
<node CREATED="1437322159989" ID="ID_1737067024" MODIFIED="1437322352065" TEXT="(equal #\A #\a)=&gt;NIL"/>
<node CREATED="1437322275995" ID="ID_1409518980" MODIFIED="1437322361533" TEXT="(equal &quot;ab&quot; &quot;ab&quot;)=&gt;T"/>
<node CREATED="1437322361893" ID="ID_165233902" MODIFIED="1437322382176" TEXT="(equal &apos;(1 2 (3 4) &apos;(1 2 (3 4))=&gt;T"/>
</node>
<node CREATED="1437321867749" ID="ID_228021910" MODIFIED="1439648119449" TEXT="equalp (equal a b) | same numerals ignoring numerial types (int, float)|same case-insensitive character ">
<node CREATED="1437322103007" ID="ID_761020040" MODIFIED="1437322429339" TEXT="(equal 2 2.0) =&gt;T"/>
<node CREATED="1437322159989" ID="ID_1067729712" MODIFIED="1437322433502" TEXT="(equal #\A #\a)=&gt;T"/>
</node>
</node>
<node CREATED="1428940214712" FOLDED="true" ID="ID_1612267746" MODIFIED="1439648053243" TEXT="bindings">
<node CREATED="1428940419622" ID="ID_1933365420" MODIFIED="1428940426177" TEXT="variable">
<node CREATED="1428854281571" ID="ID_899731783" MODIFIED="1437060347850" TEXT="setq  ; define">
...
<node CREATED="1428940266348" ID="ID_1926174655" MODIFIED="1437148333024" TEXT="function">
<node CREATED="1428855442892" ID="ID_764600550" MODIFIED="1437060359483" TEXT="apply/funcall ; apply">
...
<node CREATED="1437061439950" ID="ID_1739476661" MODIFIED="1437148341596" TEXT="&amp;key,&amp;optional, &amp;rest,&amp;body">
<node CREATED="1437148348427" ID="ID_385171216" MODIFIED="1437148567156" TEXT="&amp;key  -- smalltalk/objective-c  keyword parameters">
<node CREATED="1437148404721" ID="ID_1701515003" MODIFIED="1437148556845" TEXT="(defun multiply(x &amp;key by) (* x by))"/>
<node CREATED="1437148540290" ID="ID_1776584709" MODIFIED="1437148570139" TEXT="(multiply 1 :by 2)"/>
</node>
<node CREATED="1437148573307" ID="ID_3961571" MODIFIED="1437148595590" TEXT="&amp;rest -- . in scheme">
<node CREATED="1437148597840" ID="ID_720324433" MODIFIED="1437148640980" TEXT="(defun foobar(x &amp;rest args) (cons x args))"/>
<node CREATED="1437148642733" ID="ID_1531659841" MODIFIED="1437148662027" TEXT="(define (foobar x . args) (cons x args))"/>
<node CREATED="1437148662465" ID="ID_1738636689" MODIFIED="1437148682214" TEXT="(lambda(x . y) (cons x args))"/>
</node>
<node CREATED="1437148685501" ID="ID_804557423" MODIFIED="1437148774918" TEXT="&amp;optional">
<node CREATED="1437148777122" ID="ID_633454000" MODIFIED="1437148802727" TEXT="(defun foobar(&amp;optional (x 1) (y 2) ) (+ x y))"/>
</node>
<node CREATED="1437148705510" ID="ID_1339690784" MODIFIED="1437148769840" TEXT="&amp;body  -- eq  &amp;rest, used in defmacro"/>
</node>
<node CREATED="1428858610274" ID="ID_1746372676" MODIFIED="1437060433744" TEXT="let/labels ; let/named let">
<node CREATED="1428858666527" ID="ID_539147120" MODIFIED="1428859416382" TEXT="(labels ((inc(x) (+1 x)) (inc 3))"/>
<node CREATED="1428859206349" ID="ID_1723802063" MODIFIED="1437060492116">
<richcontent TYPE="NODE"><html>
  <head>
...
<node CREATED="1428853747801" ID="ID_553392570" MODIFIED="1437060522153" TEXT="defun  ; define">
...
<node CREATED="1428854015836" ID="ID_1316724998" MODIFIED="1437060625709" TEXT="#&apos; double"/>
...
<node CREATED="1428860064487" ID="ID_178313955" MODIFIED="1437060640884" TEXT="tail-recursive; proper tail recursive">
...
<node CREATED="1437061465369" ID="ID_1661350539" MODIFIED="1437061465369" TEXT=""/>
</node>
<node CREATED="1437061468773" ID="ID_1631715512" MODIFIED="1437061470174" TEXT="macro">
<node CREATED="1437061472225" ID="ID_1629762429" MODIFIED="1437061479627" TEXT="defmacro"/>
<node CREATED="1437061491136" ID="ID_137621124" MODIFIED="1437061497543" TEXT="macroexpand-1"/>
<node CREATED="1437061498100" ID="ID_1427735308" MODIFIED="1437061502256" TEXT="macroexpand"/>
<node CREATED="1437062479021" ID="ID_975059107" MODIFIED="1437062484087" TEXT="gensym #:">
<node CREATED="1437062497905" ID="ID_1051299755" MODIFIED="1437062509274" TEXT="name collision"/>
<node CREATED="1437062518117" ID="ID_1004973778" MODIFIED="1437062521557" TEXT="name mingling"/>
</node>
</node>
<node CREATED="1428940390665" ID="ID_1520601318" MODIFIED="1428940392941" TEXT="control">
<node CREATED="1428856447372" ID="ID_1292953119" MODIFIED="1437060670508" TEXT="case ; case">
