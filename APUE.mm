...
<node CREATED="1338637081000" FOLDED="true" ID="ID_640748604" MODIFIED="1503901178469" POSITION="right" TEXT="unbuffered IO (POSIX)">
...
<node CREATED="1338801266874" ID="ID_402093280" MODIFIED="1397272700291" TEXT="int   setvbuf(FILE *fp&#x7f;, char *buff, int mode,  size_t size);  ">
...
<node CREATED="1338821680335" FOLDED="true" ID="ID_1007390824" MODIFIED="1457088083097" TEXT="alternatives to standard IO">
...
<node CREATED="1338821724813" ID="ID_601843360" MODIFIED="1457088077912" TEXT="ASI(mmap)">
...
<node CREATED="1341237063338" FOLDED="true" ID="ID_1977167150" MODIFIED="1381478581369" TEXT="record locking">
...
<node CREATED="1341283750539" ID="ID_731699793" MODIFIED="1457088085969" TEXT="mmap">
...
<node CREATED="1341286374788" ID="ID_343853064" MODIFIED="1457088159344" TEXT="inheritance">
...
<node CREATED="1338994150146" FOLDED="true" ID="ID_194992328" MODIFIED="1573170173631" POSITION="right" TEXT="process control">
<font BOLD="true" NAME="Dialog" SIZE="16"/>
...
<node CREATED="1338994562179" ID="ID_877957790" MODIFIED="1421658541638" TEXT="init"/>
</node>
...
<node CREATED="1339079935446" ID="ID_393326232" MODIFIED="1398054260814" TEXT="pid_t wait(int *statloc);">
...
<node CREATED="1339081105787" ID="ID_517132370" MODIFIED="1446861725821" TEXT="termination status (low 16bit)">
<node CREATED="1366269219646" ID="ID_804223851" MODIFIED="1446861730185" TEXT="|-(8b)-|-coredump(1b)-|-0&lt;signal(7b)&lt;0x7f-|">
...
<node CREATED="1366269578599" ID="ID_1852704379" MODIFIED="1446861831046" TEXT="|-stop signal(8b)-|-0x7f(8b)-|">
<node CREATED="1358664208242" ID="ID_457258712" MODIFIED="1366269575114" TEXT="stopped (jop control)">
<node CREATED="1339081168883" ID="ID_265387155" MODIFIED="1446861848838" TEXT="WIFSTOPPED (status)">
...
<node CREATED="1366269715495" ID="ID_1756498677" MODIFIED="1446861818358" TEXT="|-0xffff(8b)-|">
...
<node CREATED="1366269038791" ID="ID_281573246" MODIFIED="1446861789008" TEXT="|-exit status(8b)-|-0(8b)-|">
<node CREATED="1358664183435" ID="ID_207425608" MODIFIED="1366269130521" TEXT="exited (terminate normally)">
<node CREATED="1339081168876" ID="ID_1983837262" MODIFIED="1446861795371" TEXT="WIFEXlTED (status)">
...
<node CREATED="1339079935448" ID="ID_1100869807" MODIFIED="1398054271031" TEXT="pid_t waitpid(pid_t pid&#x7f;,int *statloc, int options) ;">
<node CREATED="1339081422036" ID="ID_725128144" MODIFIED="1366266845014" TEXT="options">
<node CREATED="1358663686932" ID="ID_867859217" MODIFIED="1398054281614" TEXT="0">
<node CREATED="1358663997755" ID="ID_1729558107" MODIFIED="1358664016012" TEXT="blocking"/>
</node>
<node CREATED="1339081437044" ID="ID_716871028" MODIFIED="1398054356456" TEXT="WNOHANG ">
<node CREATED="1358664020681" ID="ID_721511481" MODIFIED="1446862163531" TEXT="non-blocking">
...
<node CREATED="1339081437049" ID="ID_1886801217" MODIFIED="1446862185744" TEXT="WUNTRACED ">
...
<node CREATED="1339081634412" ID="ID_1723621999" MODIFIED="1446862220592" TEXT="== -1">
...
<node CREATED="1358665462298" FOLDED="true" ID="ID_199916579" MODIFIED="1446862276450" TEXT="return value">
...
<node CREATED="1339076175245" FOLDED="true" ID="ID_754308123" MODIFIED="1371275528827" TEXT="exit">
...
<node CREATED="1339221960011" FOLDED="true" ID="ID_1961384818" MODIFIED="1371275526063" TEXT="accouting">
...
<node CREATED="1339225287048" FOLDED="true" ID="ID_1484205277" MODIFIED="1371275524107" TEXT="user identification">
...
<node CREATED="1339225715305" ID="ID_1521787437" MODIFIED="1371276061296" TEXT="process times">
<node CREATED="1339226532124" ID="ID_1204706641" MODIFIED="1371276055394" TEXT="&lt;sys/times.h&gt; clock_t times(struct tms *buf);">
<node CREATED="1339227115623" ID="ID_1995263056" MODIFIED="1371275031061" TEXT="clock_t using clock tick as basic measure unit">
...
<node CREATED="1339226759031" ID="ID_641700929" MODIFIED="1371275079216" TEXT="user CPU time">
...
<node CREATED="1339226987505" ID="ID_1866853532" MODIFIED="1371275506787" TEXT="$time can measure all three times of executing a process">
...
<node CREATED="1339236966305" ID="ID_688149042" MODIFIED="1421659020632" TEXT="">
...
<node CREATED="1339236753039" ID="ID_546445655" MODIFIED="1421658993305" TEXT="">
...
<node CREATED="1339236679249" ID="ID_1527342729" MODIFIED="1421658984647" TEXT="">
<node CREATED="1339236681202" ID="ID_1194900672" MODIFIED="1339236691644" TEXT="with empty environment"/>
</node>
</node>
</node>
<node CREATED="1339236467053" ID="ID_626401796" MODIFIED="1421658955074" TEXT="">
<node CREATED="1339236470215" ID="ID_46179129" MODIFIED="1421658957460" TEXT="reads /etc/ttys">
...
<node CREATED="1339237584693" FOLDED="true" ID="ID_1680392759" MODIFIED="1421659126802" TEXT="SVR4 terminal login">
...
<node CREATED="1339238866067" ID="ID_1668813235" MODIFIED="1421659163543" STYLE="fork" TEXT="SVR4 network login">
...
<node CREATED="1339238778552" ID="ID_884518839" MODIFIED="1421659157980" TEXT="">
<node CREATED="1339238780457" ID="ID_1201075422" MODIFIED="1421659157980" TEXT="open pseudo-terminal device"/>
</node>
</node>
</node>
<node CREATED="1339238612715" FOLDED="true" ID="ID_849022986" MODIFIED="1421659157980" TEXT="">
<node CREATED="1339238614840" ID="ID_1638160654" MODIFIED="1339238633648" TEXT="wait for internet connections"/>
</node>
</node>
</node>
<node CREATED="1339238161530" FOLDED="true" ID="ID_781546729" MODIFIED="1421659157980" TEXT="">
...
<node CREATED="1339239966032" ID="ID_553996094" MODIFIED="1421659169342" TEXT="process group">
...
<node CREATED="1339241169319" ID="ID_1449027070" MODIFIED="1421659291991" TEXT="int setpgrp(void);">
...
<node CREATED="1339241755829" ID="ID_1488236355" MODIFIED="1421658817257" TEXT="session">
...
<node CREATED="1339249906475" ID="ID_1806623540" MODIFIED="1421659374393" TEXT="get&amp;set terminal fg process grp">
...
<node CREATED="1339250092468" ID="ID_1249745950" MODIFIED="1421659380401" TEXT="job control">
...
<node CREATED="1339310541091" FOLDED="true" ID="ID_1385180175" MODIFIED="1503901166843" POSITION="right" TEXT="signal">
<font BOLD="true" NAME="Dialog" SIZE="16"/>
...
<node CREATED="1339314582156" FOLDED="true" ID="ID_563473174" MODIFIED="1381482568380" TEXT="handle signal">
<node CREATED="1339314590900" ID="ID_1838530542" MODIFIED="1381482545632" TEXT="ignore">
<node CREATED="1339314618052" ID="ID_867197543" MODIFIED="1381482550959" TEXT="SIGSTOP and SIGKILL can never be ignored "/>
<node CREATED="1339314717385" ID="ID_1736488142" MODIFIED="1381482561201" TEXT="signals generated by hardware exception are not supposed to be ignored  "/>
</node>
...
<node CREATED="1339316700815" FOLDED="true" ID="ID_1261269996" MODIFIED="1371285485884" TEXT="all signals ($ kill -l)">
...
<node CREATED="1339421990488" ID="ID_118537351" MODIFIED="1381482584921" TEXT="interruptible system call">
...
<node CREATED="1339512363209" FOLDED="true" ID="ID_1186971720" MODIFIED="1381482637339" TEXT="send signal">
<node CREATED="1339511296268" ID="ID_908651015" MODIFIED="1381482631199" TEXT="int kill(pid_t pid, int signo);">
...
<node CREATED="1339679944156" ID="ID_1617527858" MODIFIED="1381482640464" TEXT="mask signal">
...
<node CREATED="1363226820411" FOLDED="true" ID="ID_1875943844" MODIFIED="1381483209476" TEXT="unblock &amp; block signals">
<node CREATED="1339682943811" ID="ID_1520795721" MODIFIED="1381483201216" TEXT="sigprocmask">
...
<node CREATED="1363225329806" ID="ID_168661165" MODIFIED="1381482793972" TEXT="If there are any pending, unblocked signals after the call to sigprocmask, at least  one of these signals is delivered to the process before sigprocmask returns.  "/>
</node>
</node>
...
<node CREATED="1339679949543" ID="ID_6260115" MODIFIED="1381483219046" TEXT="handle signal">
...
<node CREATED="1363228642845" ID="ID_677880863" MODIFIED="1381483630678" TEXT="If signo is SIGCHLD, this option causes the system not to  create zombie processes when children of the calling  process terminate. If the calling process subsequently calls  wait, it blocks until all its child processes bave terminated  and then returns -1 with errno set to ECHILD. "/>
</node>
</node>
...
<icon BUILTIN="button_ok"/>
<node CREATED="1339681151633" ID="ID_420422895" MODIFIED="1381483442653" TEXT="interrupted system call is automatically restarted "/>
</node>
...
<node CREATED="1339681733513" ID="ID_1646499008" MODIFIED="1381483424833" TEXT="the same signal is blocked when the signal is caught ">
<icon BUILTIN="messagebox_warning"/>
</node>
</node>
<node CREATED="1339680931716" ID="ID_1056990469" MODIFIED="1381483985884" TEXT="SA_SIGINFO">
<node CREATED="1363227898311" ID="ID_88061912" MODIFIED="1381483330151" TEXT="This option provides additional information for a signal  handler. Refer to Section 10.21 for additional details.  "/>
</node>
</node>
</node>
</node>
...
<node CREATED="1339685022002" ID="ID_893451140" MODIFIED="1381484047616" TEXT="suspend signal">
...
<node CREATED="1339684682355" ID="ID_779947799" MODIFIED="1395228409871" TEXT="sigsetjmp siglongjmp">
...
<node CREATED="1339684798042" ID="ID_215440727" MODIFIED="1381484115506" TEXT="save signal mask and restore signal mask "/>
</node>
</node>
</node>
<node CREATED="1340372827739" ID="ID_1514224846" MODIFIED="1371105653414" TEXT="library functions impletemented with signals">
...
<node CREATED="1339853940517" ID="ID_721897055" MODIFIED="1381484134926" TEXT="if abort causes termination of process,before termination,flush all output streams. ">
<icon BUILTIN="full-2"/>
</node>
</node>
...
<node CREATED="1340373429940" FOLDED="true" ID="ID_13458321" MODIFIED="1503901180694" POSITION="right" TEXT="terminal IO">
<font BOLD="true" NAME="Dialog" SIZE="16"/>
