...
<node CREATED="1498755720754" ID="ID_1211666986" MODIFIED="1501468559757" POSITION="right" TEXT="GC">
<node CREATED="1498756388542" ID="ID_1489106020" MODIFIED="1503280322045" TEXT="4 GC">
...
<node CREATED="1498755774712" FOLDED="true" ID="ID_941458214" MODIFIED="1503280323430" TEXT="G1">
...
<node CREATED="1498915348538" ID="ID_1314646328" MODIFIED="1498915405020" TEXT="must also scan and follow all references from objects in the survivor regions"/>
<node CREATED="1498915419898" ID="ID_1444189478" MODIFIED="1498915443558" TEXT="must be completed before next GC is allowed to start"/>
</node>
<node CREATED="1498889300247" ID="ID_1135664274" MODIFIED="1498889305662" TEXT="3. concurrent mark">
<node CREATED="1498915447691" ID="ID_465781450" MODIFIED="1498915522784" TEXT="mark live object graph"/>
</node>
...
<node CREATED="1500729533364" ID="ID_1183722365" MODIFIED="1500729547829" POSITION="right" TEXT="ClassLoader">
<node CREATED="1500729617689" ID="ID_1713277597" MODIFIED="1500729620126" TEXT="spec">
<node CREATED="1500729549932" ID="ID_86739012" MODIFIED="1500729622190" TEXT="JLS, 3rd edition"/>
...
<node CREATED="1500730676108" ID="ID_1645128765" MODIFIED="1500730703684" TEXT="procedure">
<node CREATED="1500730607223" ID="ID_91740982" MODIFIED="1500730710724" TEXT="1.takes class name"/>
<node CREATED="1500730620003" ID="ID_1077215234" MODIFIED="1500730713802" TEXT="2.finds classfile"/>
<node CREATED="1500730650124" ID="ID_657656549" MODIFIED="1500730719082" TEXT="3.defines class"/>
<node CREATED="1500730653498" ID="ID_193606412" MODIFIED="1500730722964" TEXT="4.create instance of java.lang.Class"/>
</node>
<node CREATED="1500730725651" FOLDED="true" ID="ID_906609560" MODIFIED="1500731021214" TEXT="errors">
<node CREATED="1500730732557" ID="ID_699992774" MODIFIED="1500730739402" TEXT="NoClassDefFound"/>
<node CREATED="1500730760299" ID="ID_1461178418" MODIFIED="1500730766586" TEXT="ClassFormatError">
<node CREATED="1500730768690" ID="ID_740819982" MODIFIED="1500730785048" TEXT="format checking on the syntax of the classfile"/>
</node>
<node CREATED="1500730786900" ID="ID_1066997896" MODIFIED="1500730802661" TEXT="UnsupportedClassVersionError"/>
<node CREATED="1500730896806" ID="ID_37621745" MODIFIED="1500730911313" TEXT="ClassCircularityError">
<node CREATED="1500730914791" ID="ID_1169512006" MODIFIED="1500730951737" TEXT="a class is its own super{class, interface}"/>
</node>
<node CREATED="1500730953069" ID="ID_1737099839" MODIFIED="1500730963957" TEXT="IncompatibleClassChangeError">
<node CREATED="1500730966106" ID="ID_1559323433" MODIFIED="1500731003529" TEXT="direct super{interface, class}  is not {interface, class}"/>
</node>
</node>
<node CREATED="1500731033204" ID="ID_1012458026" MODIFIED="1500731088488" TEXT="HotSpot VM must load all its super{classes, interfaces} before completing the load of a Java class"/>
<node CREATED="1500731120195" ID="ID_1109654115" MODIFIED="1500731123545" TEXT="Linking">
<node CREATED="1500731149228" ID="ID_707223496" MODIFIED="1500731153494" TEXT="verification">
<node CREATED="1500731124316" ID="ID_1980237860" MODIFIED="1500731154561" TEXT="checks the classfile semantics"/>
<node CREATED="1500731155487" ID="ID_536690522" MODIFIED="1500731166843" TEXT="checks the constant pool symbols"/>
<node CREATED="1500731167107" ID="ID_1238883243" MODIFIED="1500731174228" TEXT="type checking"/>
<node CREATED="1500731221157" ID="ID_1940160315" MODIFIED="1500731227684" TEXT="preparation">
<node CREATED="1500731228445" ID="ID_1315062783" MODIFIED="1500731251979" TEXT="creates/initializes static fields"/>
<node CREATED="1500731252510" ID="ID_1395098317" MODIFIED="1500731262987" TEXT="allocates method tables"/>
</node>
<node CREATED="1500731276391" ID="ID_1222942604" MODIFIED="1500731294001" TEXT="resolves symbolic references"/>
</node>
<node CREATED="1500731189756" ID="ID_1892264580" MODIFIED="1500731191081" TEXT="errors">
<node CREATED="1500731183149" ID="ID_349786677" MODIFIED="1500731191822" TEXT="VerifyError"/>
</node>
</node>
<node CREATED="1500731296669" ID="ID_243541901" MODIFIED="1500731302395" TEXT="Initializing">
<node CREATED="1500731303152" ID="ID_1385524788" MODIFIED="1500731320950" TEXT="runs class static initializers"/>
<node CREATED="1500731322490" ID="ID_1780250493" MODIFIED="1500731383393" TEXT="class initialization requires superclass initialization, not superinterface initialization"/>
</node>
</node>
<node CREATED="1500730122194" ID="ID_1630035466" MODIFIED="1500730165773" TEXT="resolving constant pool symbols"/>
<node CREATED="1500730188041" ID="ID_696336022" MODIFIED="1500730196085" TEXT="Class.forName()"/>
<node CREATED="1500730196313" ID="ID_1091550915" MODIFIED="1500730205911" TEXT="ClassLoader.loadClass()"/>
<node CREATED="1500730206590" ID="ID_439557859" MODIFIED="1500730214280" TEXT="reflection APIs"/>
<node CREATED="1500730214687" ID="ID_1362937932" MODIFIED="1500730220780" TEXT="JNI_FindClass"/>
<node CREATED="1500730229420" ID="ID_1160703919" MODIFIED="1500730264829" TEXT="load java.lang.* at HotSpot VM startup time"/>
</node>
</node>
</map>
